...
// Your company has purchased a new ordering system and hired Bob the Highly Paid Consultant to develop a front end.
// However, after continuous delays and missed deliverables, his contract has now come to an end. Bob vanishes like a
// ghost into the fog, leaving you to see if you can salvage the pieces of his work.

// One thing is clear: Bob has left a chain of broken promises in his wake.

// Can you help to fix things?

// In the sample test case (submitOrder(12345)), "Your order was placed successfully" should be logged to the console.
...
// As you may have gathered, the purpose of this Kata is to familiarize yourself with using JavaScript Promises for
