...
// of the element if found and "Not found" otherwise. Your task is to shorten 
// the code as much as possible in order to meet the strict character count 
// requirements of the Kata. (no more than 161) You may assume that all array elements are unique.

// Solution:

function find(ar,e){
    return ar.indexOf(e)>=0?ar.indexOf(e):"Not found";
}